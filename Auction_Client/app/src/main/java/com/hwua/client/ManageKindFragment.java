...
public class ManageKindFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		// 定义发送请求的URL
		String url = HttpUtil.BASE_URL + "kinds_selectDatas.action?page=1&rows=100";
		try
		{
			// 向指定URL发送请求，并把响应包装成JSONArray对象
			final JSONArray jsonArray = new JSONObject(HttpUtil.getRequest(url)).getJSONArray("rows");
