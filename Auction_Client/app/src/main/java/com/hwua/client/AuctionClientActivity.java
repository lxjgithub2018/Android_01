        ...
        if (mTwoPane) {
            ...
            switch ((int) id) {
                ...
                case 0:
                    ...
                    arguments.putString("action", "items_winerItems.action?states.stateId=2&page=1&rows=100");
                    // 向Fragment传入参数
                ...
                case 1:
                    ...
                    arguments2.putString("action", "items_selectDatas.action?states.stateId=3&page=1&rows=100");
                    // 向Fragment传入参数
            ...
            switch ((int) id) {
                ...
                case 0:
                    ...
                    intent.putExtra("action", "items_winerItems.action?states.stateId=2&page=1&rows=100");
                ...
                case 1:
                    ...
                    intent.putExtra("action", "items_selectDatas.action?states.stateId=3&page=1&rows=100");
                    startActivity(intent);
                    break;
                // 管理物品种类
                case 2:
