...
public class BidArrayAdapter extends BaseAdapter
{
	private Context ctx;
	// 定义需要包装的JSONArray对象
	...
	public BidArrayAdapter(Context ctx
	...
	public long getItemId(int position)
	{
		...
		{
			// 返回物品的ID
			return ((JSONObject)getItem(position)).getInt("bidId");
		}
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		try
		{
			...
			String itemName = ((JSONObject)getItem(position)).getJSONObject(property).getString("itemName");
			// 设置TextView所显示的内容
			tv.setText(itemName);
		}
		catch (JSONException e)
