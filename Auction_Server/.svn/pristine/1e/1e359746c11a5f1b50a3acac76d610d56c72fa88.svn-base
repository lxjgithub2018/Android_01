...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/Kinds.js"></script>
</head>
 ...
 <body class="easyui-layout">
 	<div class="easyui-panel" style="height:754px;padding:10px;">
		...
		<table id="dg" style="width:100%;height:400px" class="easyui-datagrid" data-options="url:'${pageContext.request.contextPath}/kinds_selectDatas',method:'post',rownumbers:true,pagination:true,border:true,singleSelect:true">
		</table>
	</div>
	
	<div id="add" class="easyui-dialog" title="添加商品类别" 
		data-options="modal:true,closed:true,iconCls:'icon-add',buttons:'#add-dlg-buttons',
		href:'${pageContext.request.contextPath}/kinds_add',method:'post'" 
	...
	<div id="search" class="easyui-dialog" title="查询条件" 
		...
		href:'${pageContext.request.contextPath}/kinds_search',method:'post'"
		style="width:500px;height:200px;padding:10px;">
    ...
    <div id="edit" class="easyui-dialog" title="修改商品类别" 
    	data-options="modal:true,closed:true,iconCls:'icon-edit',buttons:'#edit-dlg-buttons',
		href:'${pageContext.request.contextPath}/kinds_edit',method:'post'" 
		style="width:500px;height:200px;padding:10px;">
